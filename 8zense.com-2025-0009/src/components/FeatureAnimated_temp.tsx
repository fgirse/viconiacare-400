...
export default function HowItWorks() {
  ...
  return (
    <>
      <h1 className="text-center bg-stone-700 uppercase text-3xl text-white">
        {t("Howitworks")}
      </h1>
      <motion.div
      ...
      >
        <div className="h-[10%] p-5 flex flex-col items-center justify-center">
          <div className=" grid-cols-2 gap-8">
            ...
            <h2 className="text-1xl md:text-4xl text-stone-300 font-semibold mb-4 text-center">
          ...
          <p className="h-24 w-96 relative')]  text-sm px-6 text-stone-300 font-light mb-4 text-center">
            {steps[step].text}
          </p>
        </div>
      </motion.div>
